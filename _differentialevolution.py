...
#make this file work with new and old versions of scipy
#note, probably should change this around and switch back to the new OptimizeResult name in the rest of this file, but don't feel like changing
#around the rest of the source code files right now. forgot about the import as syntax when originally backported this file.
from distutils.version import StrictVersion
import scipy
if StrictVersion(scipy.__version__)>StrictVersion('0.13.3'):	#0.13.3 may not be the version required here. it actually may be a little higher, but it is less than '0.14.0'
...
def differential_evolution(func, bounds, args=(), strategy='best1bin',
                           ...
                           callback=None, disp=False, polish=True, polishmethod='L-BFGS-B',
                           init='latinhypercube', polishtol=None, polishoptions=None):
    ...
    res : Result
        ...
        was employed, then Result also contains the `jac` attribute.
    ...
    solver = DifferentialEvolutionSolver(func, bounds, args=args,
                                         ...
                                         seed=seed, polish=polish, polishmethod=polishmethod,
                                         callback=callback,
                                         disp=disp,
                                         init=init,
                                         polishtol=polishtol,polishoptions=polishoptions
)
    return solver.solve()
...
class DifferentialEvolutionSolver(object):
    ...
    def __init__(self, func, bounds, args=(),
                 ...
                 maxfun=None, callback=None, disp=False, polish=True, polishmethod='L-BFGS-B',
                 init='latinhypercube',polishtol=None,polishoptions=None):
        ...
        self.tol = tol
        self.polishtol = polishtol
        self.polishoptions = polishoptions
