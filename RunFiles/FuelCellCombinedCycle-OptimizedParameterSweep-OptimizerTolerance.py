...
#normally don't seem to need to modify the polish tolerances since the polish runs fairly quickly when the differential evolution
#optimizer finishes, but just have these defined here so remember they can be used to override the defaults from within the run file

NonCO2CycleFixedIndependentVariableValues+=[5e-5,]
NonCO2CycleIndependentVariableLabels+=('Optimizer Polish Tolerance',)
NonCO2CycleIndependentVariableMappings+=("polishtol",)

NonCO2CycleFixedIndependentVariableValues+=[200,]
NonCO2CycleIndependentVariableLabels+=('Optimizer Polish Max Iterations',)
NonCO2CycleIndependentVariableMappings+=("polishmaxiter",)
...
NonCO2CycleSweptIndependentVariableValues+=[linspace(1,650,num=25),]
NonCO2CycleIndependentVariableLabels+=('Optimizer Population Size',)
NonCO2CycleIndependentVariableMappings+=("popsize",)

NonCO2CycleSweptIndependentVariableValues+=[2.**-arange(10),]
NonCO2CycleIndependentVariableLabels+=('Optimizer Tolerance',)
NonCO2CycleIndependentVariableMappings+=("tol",)
