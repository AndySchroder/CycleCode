...
#limit the number of engines to allow in the combined cycle
NonCO2CycleSweptIndependentVariableValues+=(iarange(1,6),)		#includes the topping cycle
NonCO2CycleIndependentVariableLabels+=('Maximum Allowable Number of Engines',)
NonCO2CycleIndependentVariableMappings+=('NumberOfEngines',)
