...
NonCO2CycleSweptIndependentVariableValues+=[linspace(0.8,0.9,20),]	#isentropic efficiency of 0.30 resulted in too high of a compressor outlet temperature
NonCO2CycleIndependentVariableLabels+=('Gas Turbine Compressor Isentropic Efficiency',)
NonCO2CycleIndependentVariableMappings+=("CycleInputParameters['MainCompressor']['IsentropicEfficiency']",)
